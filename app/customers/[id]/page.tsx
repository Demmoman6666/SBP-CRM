    ...
    <section className="card">
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: 12, marginBottom: 16 }}>
        <div
          ...
          style={{ padding: "16px", border: mode === "precall" ? "2px solid var(--pink)" : "1px solid var(--border)", borderRadius: 12, cursor: "pointer", background: mode === "precall" ? "var(--pink-light)" : "#fff", transition: "all 0.15s" }}
        >
        ...
        <div
          ...
          style={{ padding: "16px", border: mode === "snapshot" ? "2px solid var(--pink)" : "1px solid var(--border)", borderRadius: 12, cursor: "pointer", background: mode === "snapshot" ? "var(--pink-light)" : "#fff", transition: "all 0.15s" }}
        >
      ...
      {loading && (
        <div style={{ textAlign: "center", padding: 32 }}>
          ...
          <p className="small muted">Reading call history, orders and account data. Takes 15-30 seconds.</p>
        </div>
      )}

      {error && (
        <div className="small" style={{ color: "var(--red)", padding: "10px 14px", background: "#fee2e2", borderRadius: 8 }}>{error}</div>
      )}
