...
export default function NewOrderPage() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // Success: send them to Shopify draft order, or back to customer
      if (json.invoiceUrl) {
        window.open(json.invoiceUrl, "_blank");
      }
      if (json.shopifyDraftOrderId && json.adminUrl) {
        window.open(json.adminUrl, "_blank");
      }
      // bounce back to customer page
