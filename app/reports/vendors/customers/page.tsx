    ...
    <div className="grid" style={{ gap: 16 }}>
      ...
      <section className="card" style={{ overflowX:"auto" }}>
        {loading ? <div className="small">Loading…</div> :
         rows.length === 0 ? <div className="small">No customers found.</div> :
         <table className="table">
           <thead>
             <tr><th>Customer</th><th>Email</th><th>City</th><th style={{textAlign:"right"}}>Orders</th><th style={{textAlign:"right"}}>Revenue</th></tr>
           </thead>
           <tbody>
             {rows.map(r => (
               <tr key={r.id}>
